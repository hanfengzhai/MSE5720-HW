...
ibrun pw.x < CCO.rand2.in > CCO.rand2.out # Run the executable named pw.x 
# mpirun -np 68 

INFILE="$PREFIX.phon_rand2.in"
OUTFILE="$PREFIX.phon_rand2.out"
