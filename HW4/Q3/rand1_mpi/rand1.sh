...
ibrun pw.x < CCO.rand1.in > CCO.rand1.out # Run the executable named pw.x 
# mpirun -np 68 


INFILE="$PREFIX.phon_rand1.in"
OUTFILE="$PREFIX.phon_rand1.out"
