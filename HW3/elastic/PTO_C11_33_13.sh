...
PREFIX="PTO_C11_C33_C13"
PSEUDO_DIR="./"
INFILE="$PREFIX.in"
OUTFILE="$PREFIX.out"

eta_list="3.8327 3.8404 3.8481 3.8558 3.8635 3.8712 3.8789"
eta_tetra_list="4.0757 4.0676 4.0595 4.0514 4.0433 4.0352 4.0271"

set $eta_tetra_list
for eta in $eta_list
do
cat > PTO.C11_C33_C13.$eta.in << EOF
&CONTROL
 calculation = 'relax',
...
pw.x < PTO.C11_C33_C13.$eta.in > PTO.C11_C33_C13.$eta.out # Run the executable named pw.x 
shift
done
